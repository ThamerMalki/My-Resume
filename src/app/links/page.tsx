import { GitHubIcon, ArrowIcon, LinkedInIcon, DiscordIcon,TwitterIcon } from '@/components/icons';
    ...
    <section className="pb-32">
      ...
      <div className="flex flex-col gap-2 md:flex-row md:gap-2 pt-16">
        <Link
          ...
          target="_blank"
          href="https://www.linkedin.com/in/thamer-malki/"
        ...
        <Link
          rel="noopener noreferrer"
          target="_blank"
          href="https://github.com/ThamerMalki"
