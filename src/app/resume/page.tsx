...
import { backendSkills, frontendSkills } from '@/utils/skills';  //otherSkills
    ...
    <>
      ...
      <div className="flex w-full flex-col sm:flex-row">
        <div className="py-2 pr-12 ">
          <h4 className="text-lg font-bold text-center">Programming languages</h4>
          <hr />
          <Skills skills={frontendSkills} className="odd:lg:flex-row-reverse" />
        </div>
        <div className="py-2 px-2 ">
          <h4 className="text-lg font-bold text-center">Technologies</h4>
          <hr />
    ...
    <>
      ...
      <div className="flex flex-col gap-y-6 justify-between">
        ...
        <div className="flex flex-col sm:flex-row justify-between">
          <div className="flex flex-col justify-between">
            <p>
              <strong>Bachelors in Computer Science | GPA 3.99 | CGPA 4.0</strong>
            </p>
            <p>August 2019 - Expected June 2024</p>
          </div>
          <div className="flex justify-between flex-col sm:text-right">
            <p>Taif University</p>
            <p>Taif, SA</p>
